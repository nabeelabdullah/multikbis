...
<html>
    <head>
        ...
        <link href="sendrequestprofile/sendrequestprofile.css" type="text/css" rel="stylesheet">
        <script src="sendrequestprofile/sendrequestprofile.js" type="text/javascript" ></script>
