...
function itext_sender()
{
   ...
   {
        globaltxt=itxt;
        var url="full_post_button?itxt="+escape(itxt);
...
function like_sender(piid,uiid,unm){
    ...
    if(s=="red"){}
        ...
        document.getElementById(piid+"_div").insertAdjacentHTML("beforeend","<a style='color: #0000FF;'>you</a>"+";");
...
function _scroller(){
    ...
    if(sc_top+win_h>=sc_height-40 && globaltxt!=3)        
    {
    qql=objectCreator();
    var ul="full_post_scroll?itxt="+escape(globaltxt);
